...
var CarBox = React.createClass({displayName: 'CarBox',
    ...
    handleCarDelete: function(car){
        var data = {car_id:car};
        var cars = this.state.data;
        var newCars = cars.filter(function(el){ return el.car_id != car; });
    ...
    handleCarEdit: function(car){
        ...
        var cars = this.state.data;
        var newCars = cars.filter(function(el){ return el.car_id != car.car_id; });
        newCars.concat(car);
    ...
    getInitialState: function (){
        return {data:[], filter:{car_brand: '',car_model:'', car_min_price:'0', car_max_price : '1000000000',
            car_min_kilometer: '0',car_max_kilometer: '10000000',car_district: '' ,car_fuel_type:'' , car_order:'asc', search_type: 'car_id',user_id:'0' }, order:{present:'asc'},edit:{car:-1}};
    },
    ...
    render: function() {
        ...
        if (this.props.user_type == 'Dealer'){
            if (this.state.edit.car == -1) {
                ...
                var aux = getCarFromId(this.state.data, this.state.edit.car);
                return(
                <div className="commentBox" style={divstyle}>
                    ...
                    <CarList data={filtered}
                             ...
                             user_id   = {this.props.user_id}
                    />
                    <CarEditForm onCarSubmit={this.handleCarEdit}
                                 car_id={this.state.edit.car}
                                 onCarEdit = {this.handleCarEdit}
                                 data = {aux[0]}/>
                    <CarSearchForm onCarSearchSubmit={this.handleCarSearchSubmit}
                                   user_district = {this.props.user_district}
                                   user_id = {this.props.user_id}
...
var CarEditForm = React.createClass({
    getInitialState: function(){
        return {
